        ...
        if self.current_epoch > 0 and self.current_epoch % 100 == 0:
            ...
            if len(self.epoch_predictions) > 0:
                ...
                if not os.path.exists('./dataset_generation/runtime_prediction_data/previous_data.npy'):
                    ...
                    np.save('./dataset_generation/runtime_prediction_data/previous_data.npy', predictions_numpy)
                else:
            ...
            self.trainer.datamodule.update_data(self.trainer.current_epoch, update_type = 'pred', file_path_xprime='./dataset_generation/runtime_prediction_data/previous_data.npy')